...
enum KnxExtendedCommandType {
    ...
    KNX_EXT_COMMAND_MEM_READ         = B000000,
    KNX_EXT_COMMAND_MEM_ANSWER       = B000000,
    KNX_EXT_COMMAND_MEM_WRITE        = B000000, // 1-11 Byte
    KNX_EXT_COMMAND_MEM_WRITE_BIT    = B000000, // 1-40 Bit
